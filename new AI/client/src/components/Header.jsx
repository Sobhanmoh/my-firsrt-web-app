...
const Header = () => {
  return (
    ...
    <div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 
    ...
    <p className='text-center max-w-xl max-auto mt-5'> 
        Unleash your creativity whit AI. Turn your imagination
         into visual art in seconds - just type, 
         and whtch th magic happen!</p>
...
<p className='mt-2 text-neutral-600'>Generated images from SOBHAN AI</p>
